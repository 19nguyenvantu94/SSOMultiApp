...
namespace Authen.Data.Migrations.ApplicationDb
{
    ...
    [Migration("20250627163454_ChangeAutoIncrement")]
    partial class ChangeAutoIncrement
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Authen.Models.ClientClaimPolicy", b =>
                {
                    ...
                    b.ToTable("ClientClaimPolicies", "Identity");
            ...
            modelBuilder.Entity("Authen.Models.ClientClaimPolicyRole", b =>
                {
                    ...
                    b.Property<int>("ClientClaimPolicyId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ClientClaimPolicyId", "RoleId")
                        .IsUnique();

                    b.ToTable("ClientClaimPolicyRoles", "Identity");
                });

            modelBuilder.Entity("Authen.Users.Models.ApiLogItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Authen.Users.Models.ApplicationRoleClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Authen.Users.Models.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Authen.Users.Models.ApplicationUserClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Authen.Users.Models.ApplicationUserRole", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Authen.Users.Models.Log", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Authen.Users.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Authen.Users.Models.UserProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Authen.Models.ClientClaimPolicyRole", b =>
                {
                    ...
                    b.HasOne("Authen.Users.Models.ApplicationRole", "Role")
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ClientClaimPolicy");
            ...
            modelBuilder.Entity("Authen.Users.Models.ApiLogItem", b =>
                {
                    b.HasOne("Authen.Users.Models.ApplicationUser", "ApplicationUser")
            ...
            modelBuilder.Entity("Authen.Users.Models.ApplicationUserClaim", b =>
                {
                    b.HasOne("Authen.Users.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Authen.Users.Models.ApplicationUserRole", b =>
                {
                    ...
                    b.HasOne("Authen.Users.Models.ApplicationUser", "User")
                        .WithMany("UserRoles")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Authen.Users.Models.Message", b =>
                {
                    b.HasOne("Authen.Users.Models.ApplicationUser", "Sender")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("Authen.Users.Models.UserProfile", b =>
                {
                    b.HasOne("Authen.Users.Models.ApplicationUser", "ApplicationUser")
                        .WithOne("Profile")
                        .HasForeignKey("Authen.Users.Models.UserProfile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
